...
A feature 04 ganha sua própria pasta com `spec.md` e `tasks/` quando a 03 estiver concluída — especificar muito à frente tende a ficar desatualizado antes de virar código.
